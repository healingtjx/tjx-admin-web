...
<script>
import { deleteResourceCategory, changeResourceCategory, resourceCategoryList } from '@/api/ums/resource'
...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      resourceCategoryList(this.listQuery).then(response => {
    ...
    changeData() {
      ...
      this.$refs['dataForm'].validate((valid) => {
        if (valid) {
          changeResourceCategory(this.temp).then(() => {
